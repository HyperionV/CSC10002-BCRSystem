...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->kryptonDataGridView4->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(10) {
				this->dataGridViewTextBoxColumn15,
					...
					this->dataGridViewTextBoxColumn20, this->dataGridViewTextBoxColumn21, this->Column9, this->Column10, this->Column8
			});
			...
			// Column8
			// 
			this->Column8->HeaderText = L"Update/Edit";
