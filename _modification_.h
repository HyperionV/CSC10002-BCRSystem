...
void addSchoolYearNode(schoolYear*& head, const schoolYear& _head);
...
void deleteSchoolYearList(scoreboardNode*& head);
...
schoolYearNode* findSchoolYear(schoolYear* head, const string& _schoolYear);
